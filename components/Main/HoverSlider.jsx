...
function HoverSliderDemo() {
  return (
    <HoverSlider className="min-h-svh place-content-center p-2 md:px-4 bg-[#faf9f5] text-[#3d3929]">
      <h2 className="mb-8 text-5xl md:text-6xl font-bold text-center text-[#3d3929]">
        Our Services
      </h2>
